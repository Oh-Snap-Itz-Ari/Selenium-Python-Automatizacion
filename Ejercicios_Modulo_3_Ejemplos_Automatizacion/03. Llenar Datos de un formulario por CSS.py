...
# 8. Busca el elemento a través del CSS y envia el valor de "Alex Fabián Melo Gómez"
name = driver.find_element(By.CSS_SELECTOR,"#userName").send_keys("Alex Fabián Melo Gómez")
time.sleep(1)

email = driver.find_element(By.CSS_SELECTOR,"#userEmail").send_keys("alexfabianmelo12@hotmail.com")
time.sleep(1)

address = driver.find_element(By.CSS_SELECTOR,"#currentAddress").send_keys("Calle 28 # 01 - 26 San Fernando")
time.sleep(1)

peraddress = driver.find_element(By.CSS_SELECTOR,"#permanentAddress").send_keys("Calle 28 # 01 - 26 San Fernando")
time.sleep(1)
...
bsubmit = driver.find_element(By.CSS_SELECTOR,"#submit").click() # 10. Le ordenamos que dé clic al botón de "Submit"
time.sleep(4)
